...
// create the function pointer of type *func_ptr[]
int (*func_ptr[])(int, int) = {&add,&sub,&mult,&divide};

// performs the given operation on elements of the arrays
// we have to pass in the function to be performed, it doesn't need to be the array, but just a single op
